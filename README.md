About pymvpa2-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymvpa2-feedstock/blob/main/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `pymvpa2` can be installed with `conda`:
...
```
mamba install pymvpa2
```

It is possible to list all of the versions of `pymvpa2` available on your platform with `conda`:
...
```
mamba search pymvpa2 --channel conda-forge
```
...
mamba repoquery search pymvpa2 --channel conda-forge

# List packages depending on `pymvpa2`:
mamba repoquery whoneeds pymvpa2 --channel conda-forge

# List dependencies of `pymvpa2`:
mamba repoquery depends pymvpa2 --channel conda-forge
```
